    ...
    <section className={`bg-[#70008C] ${`section`} transition`}>
      ...
      <div className='policyContentContainer'>
        ...
        <div className='policyContainer'>
          ...
          <p>
            If you do not agree with any statements contained within this
            Privacy Notice, please do not proceed any further on our website.
            Please be aware that registering an account on our website will be
            deemed confirmation of your full agreement with our Terms &
        ...
        <div className='policyContainer'>
          ...
          <p>
            Register an account with MetaWin Voluntarily provide it when using
          ...
          <p>Non-personally identifiable information and traffic analysis</p>
          <p>
            MetaWin strives to make our website as user friendly as possible and
            easy to find on the internet. MetaWin collects data on how you use
        ...
        <div className='policyContainer'>
          ...
          <p>
            MetaWin will use your identification document and/or proof of
            address to check your details in order for us to protect our users
            from fraudulent behaviour and comply with relevant Anti Money
          ...
          <p>
            ...
            involved are central to our business, if you wish to object further
        ...
        <div className='policyContainer'>
          ...
          <p>
            ...
            obligation; in order to enforce or apply the terms of this notice or
            any other agreements; to assist us in providing you with the
            products and services you request, including but not limited to
            third party software providers; if, in our sole determination, you
            are found to have cheated or attempted to defraud us, or other users
            of the service in any way including but not limited to game
            manipulation or payment fraud; to protect the rights, property or
            safety of us, our customers or others; and where we have received
            your permission for us to do so. Personal Information collected on
            the services may be stored and processed in any country in which we
            or our affiliates, suppliers or agents maintain facilities. By using
            our services, you expressly consent to any transfer of information
            outside of your country. When we transfer any part of your Personal
            Data outside the EEA or adequate jurisdictions we will take
            reasonable steps to ensure that it is treated as securely as it is
            within the EEA or adequate jurisdictions. These steps include but
            are not limited to the following:We may disclose your Personal Data
            to third parties:
          </p>
          <ul>
        ...
        <div className='policyContainer'>
          ...
          <p>
            ...
            periods, MetaWin takes into consideration local laws, contractual
